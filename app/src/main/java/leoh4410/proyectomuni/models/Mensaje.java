 ...
 */
public class Mensaje  implements Serializable { //extends SugarRecord {
    long numero;
    Date fechaEnviado;
    Time horaEnviado;
    Date fechaRecibido;
    ...
    public Mensaje(long numero, Date fechaEnviado, Time horaEnviado, Date fechaRecibido, Time horaRecibido, TipoUsuario tipoUsuario, String nombreUsuario, Text mensaje){
        this.numero = numero;
